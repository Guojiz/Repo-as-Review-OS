...
DeepTutor 显示，将来源 grounding、学习者记忆和闭环辅导结合起来，可以让个性化辅导质量相对最强基线提升 **10.8%**，并让五个基础模型的通用推理平均提升 **28.6%**。这只作为支持性证据，说明“来源 grounding + 学习者状态 + 闭环练习”这类设计有潜力。GitLearnOS 不声称复刻 DeepTutor、港大的平台或任何完整辅导运行时。见 arXiv:2604.26962。
