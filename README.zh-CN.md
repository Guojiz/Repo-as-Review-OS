...
[English](README.md) · [官网](https://guojiz.github.io/gitlearnos/)
...
本仓库即 **GitLearnOS**（由 `Repo-as-Review-OS` 更名而来，旧链接自动跳转）。当前状态：早期公开版本，见 [PUBLIC-ALPHA.zh-CN.md](PUBLIC-ALPHA.zh-CN.md)。
...
```text
请把 https://github.com/Guojiz/GitLearnOS 作为 GitLearnOS 模板仓库读取。
我的个人学习仓库是：<目标仓库链接>
这次第一份材料属于：<学科>
我的学习目标是：<目标>
