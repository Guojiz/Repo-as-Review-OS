...
11. 如果环境支持 skill，再读 `skills/repo-as-review-os/SKILL.md`
12. `templates/zh-CN/` 中相关模板
13. `examples/` 中相关 demo
...
6. 创建 `dashboard.md`。
7. 创建 `goals/main-goal.md`。
8. 创建 sources、models、reviews、templates、agents、automations、archive 等目录。
9. 加入 skill 运行层或记忆回退说明。
10. 询问用户第一个学习目标。
11. 汇报创建了什么。
