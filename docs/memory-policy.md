...
Repo as Review OS treats memory as a layered system.

The goal is not to force every AI platform to have the same memory feature. The goal is to make the learning state portable, inspectable, and adaptable across tools.
