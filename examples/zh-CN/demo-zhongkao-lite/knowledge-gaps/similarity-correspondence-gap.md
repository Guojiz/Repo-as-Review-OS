...
学习者最初能想到相似三角形，但不能稳定地根据等角写出正确顶点和对应边顺序。
...
- 老师反馈支持这一诊断；
- 2026-07-08 独立表现说明干预有效。

## 可证明的学习目标

在新图或符号描述中，先写等角对应，再独立写出正确相似式和比例。
...
- 日期：2026-07-15；
- 完成 [延迟复习](../reviews/2026-07-15_delayed-review.md)；
- 当前环境无真实调度器，下次 Agent 接手时检查。
